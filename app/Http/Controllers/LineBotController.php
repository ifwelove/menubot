...
class LineBotController extends Controller
{
    ...
    private function replyWithShopMenu($replyToken, $shop, $title)
    {
        ...
        $bubble = new BubbleContainerBuilder(null, new ImageComponentBuilder($imageUrl, null, 'full', '20:13', 'cover'), new BoxComponentBuilder('vertical', array_merge([new TextComponentBuilder($title, null, 'xl', 'bold')], $itemComponents)));
