...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('shopSearch', function () {
  return {
    query: '',
    results: [],
    isLoading: false,
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 1:
              ...
              _context.p = 2;
              _context.n = 3;
              return fetch("/api/search?q=".concat(encodeURIComponent(_this.query)));
            case 3:
              response = _context.v;
              _context.n = 4;
    ...
    selectShop: function selectShop(code) {
      window.location.href = "/shop/".concat(code);
    },
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('tagFilter', function () {
  return {
    activeTag: '',
    shops: [],
    allShops: [],
    ...
    filterByTag: function filterByTag(tag) {
      ...
      var tagShopCodes = Object.keys(this.tagMapping[tag] || {});
      this.shops = this.allShops.filter(function (shop) {
        return tagShopCodes.includes(shop.code);
      });
    },
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('nearbyStores', function () {
  var initialBrand = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  return {
    map: null,
    userLocation: null,
    userMarker: null,
    ...
    openNavigation: function openNavigation(store) {
